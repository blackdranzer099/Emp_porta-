    ...
    <section id="contact" className="py-16 bg-gradient-to-r from-indigo-900 via-purple-800 to-pink-700 text-white font-sans">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 max-w-md mx-auto p-8 bg-opacity-70 rounded-lg shadow-lg backdrop-blur-sm">
        ...
        <div className="relative">
          ...
          />
          <label htmlFor="name" className="absolute left-3 top-3 text-sm text-gray-400 pointer-events-none transition-all peer-focus:text-xs peer-focus:top-1 peer-focus:text-primary-color">
            Your Name
          </label>
        ...
        <div className="relative">
          ...
          />
          <label htmlFor="email" className="absolute left-3 top-3 text-sm text-gray-400 pointer-events-none transition-all peer-focus:text-xs peer-focus:top-1 peer-focus:text-primary-color">
            Your Email
          </label>
        ...
        <div className="relative">
          ...
          />
          <label htmlFor="message" className="absolute left-3 top-3 text-sm text-gray-400 pointer-events-none transition-all peer-focus:text-xs peer-focus:top-1 peer-focus:text-primary-color">
            Your Message
          </label>
